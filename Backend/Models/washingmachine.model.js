...
const washingMachineSchema = new mongoose.Schema(
  {
    ...
    product_specs: {
      ...
      washing_machine_specification: {
        function_type: { type: String, required: true },
        loading_type: { type: String, required: true },
      },
      wash: {
        dryer_capacity: { type: Number },
        wash_load: { type: Number },
        wash_load_range: { type: String, required: true },
      },
      warranty_details: {
