...
const getData = ({ token }) => {
  ...
  return axios("https://splendid-bear-cap.cyclic.app/users/personalDetail", {
    method: "GET",
    headers: {
      ...
      <Box h={"auto"} bg={"#eff7fa"}>
        ...
        >
          ...
          >
            ...
            <Text display={"flex"} color={"#c5c3c3"}>
              <Text
                mt={"-5px"}
                borderRadius={"50%"}
                w={"34px"}
     ...
     <Flex><Radio size='lg' mr={5}value="5" onClick={()=>setValue("5")} colorScheme='orange'>
          ...
          <Box border={"1px solid #eb7f00"} ml={10} width={"260px"} h={"auto"}>
            <Flex justifyContent={"space-between"}>
              <Text
                m={"20px 0px 10px 15px"}
                fontWeight={"bold"}
                fontSize={"19px"}
              >
                HOME
              </Text>
              <Radio size="lg" mr={5} colorScheme="orange"></Radio>
            </Flex>

            <Text
              m={"5px 0px 0px 15px"}
              fontStyle={"Roboto, Arial, Helvetica, sans-serif"}
              fontWeight={"bold"}
              fontSize={"16px"}
            >
              {data && data.name}
      ...
      <Flex justifyContent={"flex-end"} mt={-30} mr={20}>
        <Box border={"5px solid teal"} width={"260px"} p={3} h={"auto"}>
          <Text m={"20px 0px 10px 15px"} fontWeight={"bold"} fontSize={"19px"}>
            Payment Option
          </Text>
          <RadioGroup onChange={setValue} value={value}>
            <Flex>
