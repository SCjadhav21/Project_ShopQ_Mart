    ...
    <Box border={"1px solid red"} h={"700px"} bg={"#eff7fa"}>
      ...
      >
        ...
        <Box
          ...
          display={"flex"}
        >
          <Text display={"flex"} color={"#41afbf"}>
            <Text
              mt={"-5px"}
              borderRadius={"50%"}
              w={"34px"}
          ...
          {state ? (
            <>
              ...
              <Text
                ...
                fontSize={"18px"}
              >
                Congratulations .. Your order has been sucessfully Placed..
              </Text>
            </>
          ) : (
            <>
              <Image p={10} h={400} w={700} src={loading} />
              <Text color={"red"} fontWeight="bold" fontSize={"20px"}>
                Please Wait... We are continously checking for Order
              </Text>
            </>
          )}
        </Center>
