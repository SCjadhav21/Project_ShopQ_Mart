...
const Update=(id,e)=>{
  ...
  console.log(e)
  return axios.patch(`http://localhost:4500/cart/${id}`,payload, { headers: {"Authorization" : "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJ1c2VySWQiOiI2M2NiOWNjNTVmZjQ4NzQ0ZWZmMzdjMzAiLCJpYXQiOjE2NzQyODgzNjZ9.AyPui0HUid4sDEoUyZ_qfNzPVxd-5QQc_Cpd4ZHptZQ" }} )
  ...
  const dispatch = useDispatch()
   const [count, setCount]= React.useState(1)
    ...
    return (<Flex align="center">
      ...
      <Select onChange={(e)=>{handleUpdate(props,e.target.value)}}  size="sm" rounded="md" aria-label="Select quantity" focusBorderColor={useColorModeValue("blue.500", "blue.200")} {...props}>
       <option>{count}</option>
